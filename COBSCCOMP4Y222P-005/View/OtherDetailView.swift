...
struct OtherDetailView: View {
    ...
    @StateObject var productVM : ProductCategoryDetailViewModel = ProductCategoryDetailViewModel(for: "Accessories")
    ...
    @State var selectedSubCategory: String = "Accessories"
//    @State private var selectedSubCategory: Int = 0
    
    private let subcategory = ["Accessories" ,"PersonalCare", "HomeDecor" , "GiftVouchers", "Electronics"]
...
#Preview {
    OtherDetailView(cartViewModel: CartViewModel())
}
